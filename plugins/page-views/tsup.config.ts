...
// Combined esbuild loader (mirrors quartz-community/explorer): compiles `*.scss`
// to a CSS string and transpiles `*.inline.ts` to a minified browser-JS string,
// both imported as text. Harmless when a plugin uses neither.
